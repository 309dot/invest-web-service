...
import { formatDate, formatPercent, getProfitTextClass } from '@/lib/utils/formatters';
                ...
                .map((position, index) => {
                  ...
                  return (
                    <div key={position.symbol} className="text-sm">
                      ...
                      <div className={`font-medium ${getProfitTextClass(position.returnRate, { zeroAsNeutral: true })}`}>
