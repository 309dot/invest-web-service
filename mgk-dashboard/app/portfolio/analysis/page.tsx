...
import type { Position, PortfolioPerformancePeriod } from '@/types';
...
import { BenchmarkComparison } from '@/components/PortfolioAnalysis/BenchmarkComparison';
import { PeriodPerformanceTabs } from '@/components/analysis/PeriodPerformanceTabs';
import { AIActionItems } from '@/components/analysis/AIActionItems';
...
export default function PortfolioAnalysisPage() {
  ...
  const [performance, setPerformance] = useState<PortfolioPerformancePeriod[]>([]);
    ...
    <>
      ...
      <div className="min-h-screen p-4 md:p-8">
        <main className="max-w-7xl mx-auto space-y-6">
          ...
          {portfolioId ? (
            <PeriodPerformanceTabs portfolioId={portfolioId} initialPeriods={performance} />
          ) : null}
          ...
          {positions.length > 0 && (
            <>
              ...
              {portfolioId ? <StockComparisonChart portfolioId={portfolioId} /> : null}
            </>
          )}
