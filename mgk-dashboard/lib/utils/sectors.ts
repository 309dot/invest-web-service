...
const SECTOR_NORMALIZATION_MAP: Record<string, Sector> = {
  ...
  'communicationsservices': 'communication-services',
  ...
  'pharmaceuticalsbiotechnologylifesciences': 'health-care',
  'softwareapplication': 'information-technology',
  'softwareinfrastructure': 'information-technology',
  'itservices': 'information-technology',
  'semiconductorsequipment': 'information-technology',
  'consumerservices': 'consumer-discretionary',
  'consumerproducts': 'consumer-staples',
  'householdproducts': 'consumer-staples',
  'personalproducts': 'consumer-staples',
  'insurance': 'financials',
  'reitsspecialty': 'real-estate',
  'reitsehospitality': 'real-estate',
  'reitsspecialized': 'real-estate',
  'capitalmarkets': 'financials',
  'banksdiversified': 'financials',
  'banksregional': 'financials',
  'energyequipmentservices': 'energy',
  'oilgasconsumablesfuels': 'energy',
};
